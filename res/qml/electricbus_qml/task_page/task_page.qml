...
Window {
    ...
    Rectangle {
        ...
        RowLayout {
            ...
            Button {
                ...
                Layout.alignment: Qt.AlignHCenter
                onClicked: {
                    qmlCommunication.behaviorFromQml(QmlCommunication.QmlActions.TaskSend, "Task End")
                }
            }
        ...
        function onlinedata_recvFromCpp(jsonData) {
            ...
            for (let station in jsonData) {
                ...
                poleList.forEach(pole => {
                    ...
                    if (pole.line_dir != null) lineDirSet.add(pole.line_dir === 1 ? "上行" : "下行")
                })
            }
    ...
    Connections {
        ...
        function onTaskdata_recvFromCpp(jsonData) {
            //console.info("收到数据:", JSON.stringify(jsonData))
