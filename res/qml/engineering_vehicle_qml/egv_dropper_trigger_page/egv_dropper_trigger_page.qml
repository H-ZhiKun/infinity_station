...
Window {
            ...
            Item {
                ...
                ImagePainter {
                    ...
                    Connections {
                        ...
                        function onegvdropper_trigger_pageFromCpp(frameData) {
                            console.log("收到数据吊弦触发")
                            try {
        ...
        Rectangle {
            ...
            RowLayout {
                ...
                CheckBox {
                    ...
                    text: "录像"
                    onCheckedChanged: {
                        let recordState = checked ? 0 : 1; // 将布尔值转换为 1 或 0
                        console.log("录像状态:", recordState === 1 ? "start" : "stop");
                        qmlCommunication.behaviorFromQml(QmlCommunication.QmlActions.DropperVideoRecord,recordState);
                    }
                }
            }
        }
    ...
    Connections {
        target: qmlCommunication
        function ontrigger_recvFromCpp(data) {
            console.log("收到触发信号:", data)
            triggerCount++
        }
    }
}
