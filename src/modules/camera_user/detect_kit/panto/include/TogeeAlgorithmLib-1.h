...
PantographDetection_APIDLL int
PantographDetection_Init(const pantographDetectionModel input);
PantographDetection_APIDLL void PantographDetection_Free(void);
PantographDetection_APIDLL int
PantographDetection_Process(const pantographDetectionInput input,
                            detectResults *output);
