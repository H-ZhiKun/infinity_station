...
{
    return mue_sv_put_device_config_idx(p_bus_ctrl, device_config, DG_DEFAULT_IDX);
}
TCN_DECL_PUBLIC
MUE_RESULT
...
)
{
     ...
     */
    mue_result = \
        mue_acc_tx_start_idx(p_bus_ctrl, mue_sv_size_tx_put_device_config, card_index);
    if (MUE_RESULT_OK == mue_result)
    {
        mue_result = \
            mue_acc_tx_value8_idx(p_bus_ctrl, mue_sv_command_put_device_config, card_index);
    } /* if (MUE_RESULT_OK == mue_result) */
    if (MUE_RESULT_OK == mue_result)
    {
        mue_result = mue_acc_tx_value16_idx(p_bus_ctrl, device_config, card_index);
    } /* if (MUE_RESULT_OK == mue_result) */
    if (MUE_RESULT_OK == mue_result)
    {
    ...
    {
        mue_result = \
            mue_acc_rx_wait_idx(p_bus_ctrl, mue_sv_size_rx_put_device_config, card_index);
    } /* if (MUE_RESULT_OK == mue_result) */
    if (MUE_RESULT_OK == mue_result)
    {
...
{
    return mue_sv_get_device_config_idx(p_bus_ctrl, p_device_config, DG_DEFAULT_IDX);
}
TCN_DECL_PUBLIC
MUE_RESULT
...
)
{
     ...
     */
    mue_result = \
        mue_acc_tx_start_idx(p_bus_ctrl, mue_sv_size_tx_get_device_config, card_index);
    if (MUE_RESULT_OK == mue_result)
    {
        mue_result = \
            mue_acc_tx_value8_idx(p_bus_ctrl, mue_sv_command_get_device_config, card_index);
    } /* if (MUE_RESULT_OK == mue_result) */
    if (MUE_RESULT_OK == mue_result)
    {
        mue_result = mue_acc_tx_trigger_idx(p_bus_ctrl, card_index);
    ...
    {
        mue_result = \
            mue_acc_rx_wait_idx(p_bus_ctrl, mue_sv_size_rx_get_device_config, card_index);
    } /* if (MUE_RESULT_OK == mue_result) */
    if (MUE_RESULT_OK == mue_result)
    {
        mue_result = mue_acc_rx_value16_idx(p_bus_ctrl, p_device_config, card_index);
    } /* if (MUE_RESULT_OK == mue_result) */
    if (MUE_RESULT_OK == mue_result)
    {
        mue_result = mue_acc_rx_close(p_bus_ctrl);
...
{
    return mue_sv_put_ba_config_idx(p_bus_ctrl, ba_list_entry, DG_DEFAULT_IDX);
}
...
)
{
     ...
     * ----------------------------------------------------------------------
     */
    mue_result = mue_acc_tx_start_idx(p_bus_ctrl, mue_sv_size_tx_put_ba_config, card_index);
    if (MUE_RESULT_OK == mue_result)
    {
        mue_result = \
            mue_acc_tx_value8_idx(p_bus_ctrl, mue_sv_command_put_ba_config, card_index);
    } /* if (MUE_RESULT_OK == mue_result) */
    if (MUE_RESULT_OK == mue_result)
    {
        mue_result = mue_acc_tx_value16_idx(p_bus_ctrl, ba_list_entry, card_index);
    } /* if (MUE_RESULT_OK == mue_result) */
    if (MUE_RESULT_OK == mue_result)
    {
        mue_result = mue_acc_tx_trigger_idx(p_bus_ctrl, card_index);
    ...
    {
        mue_result = \
            mue_acc_rx_wait_idx(p_bus_ctrl, mue_sv_size_rx_put_ba_config, card_index);
    } /* if (MUE_RESULT_OK == mue_result) */
    if (MUE_RESULT_OK == mue_result)
    {
        mue_result = mue_acc_rx_close(p_bus_ctrl);
...
{
    return mue_sv_get_device_status_idx(p_bus_ctrl, device_address, check_received, p_port_status, p_device_status, p_freshness, DG_DEFAULT_IDX);
}
TCN_DECL_PUBLIC
MUE_RESULT
...
)
{
     ...
     */
    mue_result = \
        mue_acc_tx_start_idx(p_bus_ctrl, mue_sv_size_tx_get_device_status, card_index);
    if (MUE_RESULT_OK == mue_result)
    {
        mue_result = \
            mue_acc_tx_value8_idx(p_bus_ctrl, mue_sv_command_get_device_status, card_index);
    } /* if (MUE_RESULT_OK == mue_result) */
    if (MUE_RESULT_OK == mue_result)
    {
        mue_result = mue_acc_tx_value16_idx(p_bus_ctrl, device_address, card_index);
    } /* if (MUE_RESULT_OK == mue_result) */
    if (MUE_RESULT_OK == mue_result)
    {
        mue_result = mue_acc_tx_trigger_idx(p_bus_ctrl, card_index);
    ...
    {
        mue_result = \
            mue_acc_rx_wait_idx(p_bus_ctrl, mue_sv_size_rx_get_device_status, card_index);
    } /* if (MUE_RESULT_OK == mue_result) */
    if (MUE_RESULT_OK == mue_result)
    {
    ...
    if (MUE_RESULT_OK == mue_result)
    {
        ...
        {
            mue_result = mue_acc_rx_value16_idx(p_bus_ctrl, p_device_status, card_index);
            if (MUE_RESULT_OK == mue_result)
            {
                if (NULL != p_freshness)
                {
                    mue_result = mue_acc_rx_value16_idx(p_bus_ctrl, p_freshness, card_index);
                } /* if (NULL != p_freshness) */
                else
                {
